...
@DbTable(beanName="BmsCountryDim",baseTableName="REFT.COUNTRY",parentBeanName="BmsRegionDim",parentBaseTableName="REFT.REGION")
public class BmsCountryDim extends NaryTreeNode {
	...
	public BmsCountryDim () {
		this.level=4;
	}
	
	// Define null constructor
		public BmsCountryDim (String ctryCd) {
			this.ctryCd = ctryCd;
			this.level  = 4;
		}
