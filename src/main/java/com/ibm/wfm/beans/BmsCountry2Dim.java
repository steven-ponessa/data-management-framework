...
@DbTable(beanName="BmsCountry2Dim",baseTableName="REFT.COUNTRY",parentBeanName="BmsMarketDim",parentBaseTableName="REFT.Market")
public class BmsCountry2Dim extends NaryTreeNode {
	@DbColumn(columnName="CTRY_ID",isId=true)
	private int        ctryId;
	@DbColumn(columnName="CTRY_CD",keySeq=1)
	private String     ctryCd;
	@DbColumn(columnName="CTRY_NM")
	private String     ctryNm;
	@DbColumn(columnName="CTRY_DESC")
	private String     ctryDesc;
	@DbColumn(columnName="CTRY_ISO_ID")
	...
	public BmsCountry2Dim () {
		this.level=4;
	}
	
	// Define null constructor
		public BmsCountry2Dim (String ctryCd) {
			this.ctryCd = ctryCd;
			this.level  = 4;
		}
	...
	@Override
	public String getCode() { return this.ctryCd; }
	...
	public boolean equals(Object obj) {
		...
		BmsCountryDim other = (BmsCountryDim) obj;
		if (
            this.ctryCd.equals(other.getCtryCd())
         && this.ctryNm.equals(other.getCtryNm())
		) return true;
		return false;
	}	
