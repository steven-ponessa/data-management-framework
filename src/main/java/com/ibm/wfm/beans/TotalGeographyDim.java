...
@DbTable(beanName="TotalGeographyDim",baseTableName="ERDM.TOTAL_GEOGRAPHY",parentBeanName="GlobalDim",parentBaseTableName="ERDM.GLOBAL")
public class TotalGeographyDim extends NaryTreeNode {
	@DbColumn(columnName="TOTAL_GEO_CD",keySeq=1)
	private String     totalGeoCd;
	@DbColumn(columnName="GLOBAL_CD",foreignKeySeq=1)
	...
	public boolean equals(Object obj) {
		...
		TotalGeographyDim other = (TotalGeographyDim) obj;
		if (
