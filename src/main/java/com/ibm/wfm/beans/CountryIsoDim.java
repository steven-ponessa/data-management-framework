...
@DbTable(beanName="CountryIsoDim",baseTableName="ERDM.COUNTRY_ISO",parentBeanName="RegionDim",parentBaseTableName="ERDM.REGION")
public class CountryIsoDim extends NaryTreeNode {
	@DbColumn(columnName="COUNTRY_ISO_CD",keySeq=1)
	...
	public boolean equals(Object obj) {
		...
		CountryIsoDim other = (CountryIsoDim) obj;
		if (
            this.countryIsoCd.equals(other.getCountryIsoCd())
	...
	public String toEtlString() {
		return 
                Helpers.formatCsvField(String.valueOf(this.countryIsoCd))
	...
	public static String getEtlHeader() {
		return 
                Helpers.formatCsvField("COUNTRY_ISO_CD")
