...
@Repository
@DbTable(beanName="BrandDim",baseTableName="REFT.BRAND")
public class BrandDim extends NaryTreeNode implements Comparable<BrandDim> {
    ...
    @Override
    public int compareTo(BrandDim o) {
