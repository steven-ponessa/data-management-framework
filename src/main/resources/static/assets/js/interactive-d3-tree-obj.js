function InteractiveD3TreeObj(treeHeight = 500, treeWidth = 1700, nodeSpacing = 210) {
   ...
   */
  var margin = { top: 00, right: 90, bottom: 00, left: 50 },
  ...
  var excludeProperties = ['code', 'description', 'effTms', 'expirTms', 'rowStatusCd', 'parent', 'x', 'y', 'id', 'x0', 'y0']

  function id3Tree(selection) {
